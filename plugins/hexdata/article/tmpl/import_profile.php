...
<div class="width-60 fltlft">
    ...
    <fieldset class="adminform">
        <legend><?php echo JText::_('EDIT_ARTICLE'); ?></legend>
        ...
        <ul class="adminformlist">
            ...
            <li>
            	<label class="required" for="jform_state"><?php echo JText::_('STATUS'); ?></label>
                <select class="inputbox" id="fieldsstate" name="fields[state]">
            
            <?php	if($profile->params->fields->state->data == "ask") :    ?>
                                
                <option value="1"><?php echo JText::_('PUBLISHED'); ?></option>
                <option value="0"><?php echo JText::_('UNPUBLISHED'); ?></option>
                <option value="2"><?php echo JText::_('ARCHIVED'); ?></option>
                <option value="-2"><?php echo JText::_('TRASHED'); ?></option>
...
<div class="width-40 fltrt">
	<?php echo JHtml::_('sliders.start', 'content-sliders', array('useCookie'=>1)); ?>
    	<?php echo JHtml::_('sliders.panel', JText::_('ARTICLE_OPTIONS'), 'publishing-details'); ?>
        ...
        <ul class="adminformlist">
            ...
            <?php endif; ?>
             ...
             <?php if($profile->params->fields->version->data <> "skip") : ?>
            
            <li>
            	<label><?php echo JText::_('VERSION'); ?></label>
                <select class="inputbox" id="fieldsversion" name="fields[version]">
                	<?php echo $this->csvoptions(JText::_('VERSION')); ?>
                </select>
			</li>
        ...
        <?php if($profile->params->fields->attribs->data <> "skip") : ?>
                
        <fieldset class="panelform">
        	<h3><?php echo JText::_('ARTICLE_OPTIONS'); ?></h3>
            <ul class="adminformlist">
            	<li>
                    <label class="hasTip" title="<?php echo JText::_('JSON_FORMAT'); ?>"><?php echo JText::_('ATTRIBS'); ?></label>
                    <select class="inputbox" id="fieldsattribs" name="fields[attribs]">
                        <?php echo $this->csvoptions(JText::_('ARTICLE_OPTIONS')); ?>
                    </select>
                </li>
            </ul>
        </fieldset>
        ...
        <?php if($profile->params->fields->images->data <> "skip" or $profile->params->fields->urls->data <> "skip") : ?>
                
        <fieldset class="panelform">
        	<h3><?php echo JText::_('IMAGE_LINKS'); ?></h3>
            <ul class="adminformlist">
            
            <?php if($profile->params->fields->images->data <> "skip") : ?>
            
            	<li>
                    <label class="hasTip" title="<?php echo JText::_('JSON_FORMAT'); ?>"><?php echo JText::_('IMAGES'); ?></label>
                    <select class="inputbox" id="fieldsimages" name="fields[images]">
                        <?php echo $this->csvoptions(JText::_('IMAGES')); ?>
                    </select>
                </li>
                
                <?php endif; ?>
                
                <?php if($profile->params->fields->urls->data <> "skip") : ?>
            
            	<li>
                    <label class="hasTip" title="<?php echo JText::_('JSON_FORMAT'); ?>"><?php echo JText::_('URLS'); ?></label>
                    <select class="inputbox" id="fieldsurls" name="fields[urls]">
                        <?php echo $this->csvoptions(JText::_('URLS')); ?>
                    </select>
                </li>
        ...
        <?php if($profile->params->fields->asset_id->data <> "skip") : ?>
                
        <fieldset class="panelform">
            <h3><?php echo JText::_('ARTICLE_PERMISSIONS'); ?></h3>
            <ul class="adminformlist">
                <li>
                    <label class="hasTip" title="<?php echo JText::_('JSON_FORMAT'); ?>"><?php echo JText::_('ARTICLE_PERMISSIONS'); ?></label>
                    <select class="inputbox" id="fieldsasset_id" name="fields[asset_id]">
                        <?php echo $this->csvoptions(JText::_('ARTICLE_PERMISSIONS')); ?>
                    </select>
                </li>
            </ul>
        </fieldset>
