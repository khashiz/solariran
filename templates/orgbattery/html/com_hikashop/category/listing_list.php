...
<div class="uk-container uk-text-zero">
	<ul class="uk-child-width-1-2 uk-child-width-1-5@m uk-text-center uk-flex-center uk-grid-medium <?php echo $this->params->get('ul_class_name'); ?>" data-uk-grid data-uk-scrollspy="cls: uk-animation-slide-bottom-small; target: > li; delay: 200;">
<?php
...
?>
		<li>
			<a class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded uk-display-block uk-text-secondary hoverAccent" href="<?php echo $link; ?>">
                <span class="uk-display-block uk-text-secondary"><img src="<?php echo JUri::base().'images/com_hikashop/upload/'.$row->file_path; ?>"></span>
                <span class="uk-display-block uk-margin-remove-top uk-text-small font f700 uk-hidden"><?php echo $row->category_name; ?></span>
